...
try {
    ...
    foreach ($name in @("upload.py", "launcher.py", "entrypoint.py", "runtime.py", "fast_upload.py", "telegram_video.py", "library_layout.py", "media_compat.py", "anime_catalog.py", "media_catalog.py", "requirements.txt")) {
